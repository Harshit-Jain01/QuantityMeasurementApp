package com.app.quantitymeasurement.qmaservice.service;
...
import com.app.quantitymeasurement.qmaservice.exception.QuantityMeasurementException;
import com.app.quantitymeasurement.qmaservice.dto.QuantityDTO;
import com.app.quantitymeasurement.qmaservice.dto.QuantityMeasurementDTO;
import com.app.quantitymeasurement.qmaservice.entity.QuantityMeasurementEntity;
import com.app.quantitymeasurement.qmaservice.model.QuantityModel;
import com.app.quantitymeasurement.qmaservice.repository.QuantityMeasurementRepository;
...
public class QuantityMeasurementServiceImpl implements IQuantityMeasurementService {
    ...
    public QuantityMeasurementDTO convert(QuantityDTO thisQuantityDTO, QuantityDTO targetUnitDTO) {
        ...
        try {
            double result = (source.getUnit() instanceof com.app.quantitymeasurement.qmaservice.unit.TemperatureUnit)
    ...
    private IMeasurable getModelUnit(String measurementType, String unit) {
        switch (measurementType) {
            case "LengthUnit":      return com.app.quantitymeasurement.qmaservice.unit.LengthUnit.valueOf(unit);
            case "WeightUnit":      return com.app.quantitymeasurement.qmaservice.unit.WeightUnit.valueOf(unit);
            case "VolumeUnit":      return com.app.quantitymeasurement.qmaservice.unit.VolumeUnit.valueOf(unit);
            case "TemperatureUnit": return com.app.quantitymeasurement.qmaservice.unit.TemperatureUnit.valueOf(unit);
